 ...
 *  NOTE
 *  ----
 *  ▸ The *design* functions for Chebyshev I, Bessel and Elliptic are
 *    **declared** here but implemented elsewhere in the project (as they
 *    always were).  The factory merely forwards the call and stores the
 *    taps.  If those helpers are missing in your build, drop‑in stubs
 *    that call Butterworth to keep comM_M_M_PIlation green.
 *  ▸ "ButterWorthLP/HP" legacy spellings remain as aliases.
 **/
#pragma once
#include "OnePole.hpp"
#include "BiQuad.hpp"
